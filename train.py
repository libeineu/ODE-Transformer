...
def get_training_stats(trainer, args=None):
    ...
    for i in range(args.encoder_layers):
        stats['enc{}_attn_input_gnorm'.format(i)] = trainer.get_meter('enc{}_attn_input_gnorm'.format(i))
        stats['enc{}_ffn_fc1_gnorm'.format(i)] = trainer.get_meter('enc{}_ffn_fc1_gnorm'.format(i))
