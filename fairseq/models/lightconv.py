...
@register_model_architecture('lightconv', 'lightconv_t2t_wmt_en_de')
def lightconv_t2t_wmt_en_de(args):
    args.encoder_normalize_before = True
    args.decoder_normalize_before = True
    args.attention_dropout = getattr(args, 'attention_dropout', 0.1)
    args.relu_dropout = getattr(args, 'relu_dropout', 0.1)
    args.encoder_layers = 35
    args.encoder_kernel_size_list = [3, 7, 15, 31, 31, 31, 31, 3, 7, 15, 31, 31, 31, 31, 3, 7, 15, 31, 31, 31, 31, 3, 7, 15, 31, 31, 31, 31, 3, 7, 15, 31, 31, 31, 31]
    args.decoder_layers = 3
    args.decoder_kernel_size_list = [3, 7, 15]
    base_architecture(args)
