...
@register_model('macaron_transformer')
class MacaronTransformerModel(FairseqModel):
    """
    ...
    def build_model(cls, args, task):
        ...
        return MacaronTransformerModel(encoder, decoder)
...
@register_model_architecture('macaron_transformer', 'macaron_transformer')
...
@register_model_architecture('macaron_transformer', 'macaron_transformer_iwslt_de_en')
def macaron_transformer_iwslt_de_en(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
...
@register_model_architecture('macaron_transformer', 'macaron_transformer_wmt_en_de')
def macaron_transformer_wmt_en_de(args):
    args.encoder_ffn_embed_dim = 1024
    args.decoder_ffn_embed_dim = 1024
    base_architecture(args)


@register_model_architecture('macaron_transformer', 'macaron_transformer_t2t_wmt_en_de')
def macaron_transformer_t2t_wmt_en_de(args):
    args.encoder_normalize_before = True
    args.decoder_normalize_before = True
    args.attention_dropout = getattr(args, 'attention_dropout', 0.1)
    args.relu_dropout = getattr(args, 'relu_dropout', 0.1)
    args.encoder_layers = 35
    macaron_transformer_wmt_en_de(args)


@register_model_architecture('macaron_transformer', 'macaron_relative_transformer_wmt_en_de')
def macaron_relative_transformer_wmt_en_de(args):
...
@register_model_architecture('macaron_transformer', 'macaron_transformer_vaswani_wmt_en_de_big')
def macaron_transformer_vaswani_wmt_en_de_big(args):
...
@register_model_architecture('macaron_transformer', 'macaron_transformer_vaswani_wmt_en_fr_big')
def macaron_transformer_vaswani_wmt_en_fr_big(args):
    args.dropout = getattr(args, 'dropout', 0.1)
    macaron_transformer_vaswani_wmt_en_de_big(args)


# default parameters used in tensor2tensor implementation
@register_model_architecture('macaron_transformer', 'macaron_transformer_wmt_en_de_big_t2t')
def macaron_transformer_wmt_en_de_big_t2t(args):
