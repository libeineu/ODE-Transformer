...
@register_model('group_sublayer_transformer')
class GroupSublayerTransformerModel(FairseqModel):
    """
    ...
    def build_model(cls, args, task):
        ...
        encoder = GroupSublayerTransformerEncoder(args, src_dict, encoder_embed_tokens)
        decoder = GroupSublayerTransformerDecoder(args, tgt_dict, decoder_embed_tokens)
        return GroupSublayerTransformerModel(encoder, decoder)

@register_model('group_sublayer_transformer_lm')
class GroupSublayerTransformerLanguageModel(FairseqLanguageModel):
    ...
    def build_model(cls, args, task):
        ...
        return GroupSublayerTransformerLanguageModel(decoder)

class GroupSublayerTransformerEncoder(FairseqEncoder):
    """
...
class GroupSublayerTransformerDecoder(FairseqIncrementalDecoder):
    """
...
class TransformerEncoderLayer(nn.Module):
    ...
    *args.encoder_normalize_before* to ``True``.
    ...
    def __init__(self, args):
        ...
        self.enc_san_step = args.enc_san_step
        self.enc_ffn_step = args.enc_ffn_step
    ...
    def forward(self, x, encoder_padding_mask):
        ...
        """
        for _ in range(self.enc_san_step):
            residual = x
        ...
        for _ in range(self.enc_ffn_step):
            residual = x
...
@register_model_architecture('group_sublayer_transformer_lm', 'group_sublayer_transformer_lm')
...
@register_model_architecture('group_sublayer_transformer_lm', 'group_sublayer_transformer_lm_big')
def group_sublayer_transformer_lm_big(args):
...
@register_model_architecture('group_sublayer_transformer_lm', 'group_sublayer_transformer_lm_wiki103')
def group_sublayer_transformer_lm_wiki103(args):
    ...
    group_sublayer_transformer_lm_big(args)


@register_model_architecture('group_sublayer_transformer_lm', 'group_sublayer_transformer_lm_gbw')
def group_sublayer_transformer_lm_gbw(args):
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 512)
...
@register_model_architecture('group_sublayer_transformer', 'group_sublayer_transformer')
def base_architecture(args):
    ...
    args.enc_san_step = getattr(args, 'enc_ffn_step', 1)
    args.enc_ffn_step = getattr(args, 'enc_ffn_step', 1)
    # args.noise = getattr(args, 'noise', False)
    # args.noise_value = getattr(args, 'noise_value', 0.3)


@register_model_architecture('group_sublayer_transformer', 'group_sublayer_transformer_iwslt_de_en')
def group_sublayer_transformer_iwslt_de_en(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
...
@register_model_architecture('group_sublayer_transformer', 'group_sublayer_transformer_t2t_iwslt_de_en')
def group_sublayer_transformer_t2t_iwslt_de_en(args):
    ...
    args.dropout = getattr(args, 'dropout', 0.3)
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
    group_sublayer_transformer_iwslt_de_en(args)

@register_model_architecture('group_sublayer_transformer', 'group_sublayer_relative_transformer_t2t_iwslt_de_en')
def group_sublayer_relative_transformer_t2t_iwslt_de_en(args):
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
    args.max_relative_length = 8
    args.k_only = True
    args.enc_calculate_num = 2
    group_sublayer_transformer_t2t_iwslt_de_en(args)


@register_model_architecture('group_sublayer_transformer', 'group_sublayer_transformer_wmt_en_de')
def group_sublayer_transformer_wmt_en_de(args):
    args.encoder_history_type = getattr(args, 'encoder_history_type', 'learnable_dense')
    args.decoder_history_type = getattr(args, 'decoder_history_type', 'learnable_dense')
...
@register_model_architecture('group_sublayer_transformer', 'group_sublayer_transformer_t2t_wmt_en_de')
def group_sublayer_transformer_t2t_wmt_en_de(args):
...
@register_model_architecture('group_sublayer_transformer', 'group_sublayer_relative_transformer_wmt_en_de')
def group_sublayer_relative_transformer_wmt_en_de(args):
    args.max_relative_length = 8
    args.encoder_layers = 6
    group_sublayer_transformer_wmt_en_de(args)



@register_model_architecture('group_sublayer_transformer', 'group_sublayer_relative_transformer_t2t_wmt_en_de')
def group_sublayer_relative_transformer_t2t_wmt_en_de(args):
    args.max_relative_length = 8
    group_sublayer_transformer_t2t_wmt_en_de(args)

@register_model_architecture('group_sublayer_transformer', 'group_sublayer_relative_transformer_t2t_wmt_en_de_big')
def group_sublayer_relative_transformer_t2t_wmt_en_de_big(args):
    args.max_relative_length = 8
